...
The floating **TraceBack agent** offers clickable demo questions and local, batch-aware guidance on repair, resale, origin evidence, and financial scenarios. Answers are calculated from the loaded records using illustrative assumptions. It is a rule-based demo, not a live LLM or legal advice.
