...
The floating **ThreadTrace.io agent** has six finance-focused demo questions. It uses the same evaluated item records as the dashboard to show current modeled credit and conditional repair, resale, origin-verification, and volume scenarios. Its $0.75/kg credit is illustrative; scenario upside is not earned credit, tax savings, or net profit. It is rule-based, with no live LLM.
