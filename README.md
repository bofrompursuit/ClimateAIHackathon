...
The **Circular compliance copilot** below the rejection reasons offers three prompts and a question box. It uses the currently loaded batch to explain rejection patterns, origin gaps, disposition routing, and a finance summary. Responses are generated by local rules; there is no live AI service or production integration.
